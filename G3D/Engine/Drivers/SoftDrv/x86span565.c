...
/*                                                                                      */
/*  Author:       Ken Baird                                                             */
/*  Description:  565 assembly calls for tons of renderstates                           */
/*                                                                                      */
...
/*
Alot of this code uses some really bizzare fpu tricks to do two
pixel blends at a time.  I never got time to properly dword align
the perspective correct mappers.  This would get us gains I think.
Unrolling is evil in here.  This stuff shouldn't be unrolled
*/
...
#pragma warning (disable:4410)	//illegal size for operand

void	DrawScanLineGouraudNoZ_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
void	DrawScanLineGouraudNoZTrans_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
void	DrawScanLineGouraudZBuffer_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
void	DrawScanLineGouraudZBufferNoZWrite_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
void	DrawScanLineGouraudNoZBufferZWrite_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
void	DrawScanLineGouraudZBufferTrans_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
void	DrawScanLineGouraudZBufferNoZWriteTrans_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
void	DrawScanLineGouraudNoZBufferZWriteTrans_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
void	DrawScanLineGouraudNoZSolid_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
NoSinglePixie:
		...
		frndint
		fld		qword ptr[RedMask]				; rm   BI   GL   RI   RL   BL   GI
		fmul	st(3),st						; rm   BI   GL   RI   RL   BL   GI
		fmulp	st(4),st						; BI   GL   RI   RL   BL   GI
		fld		dword ptr[GreenMask]			; gm   BI   GL   RI   RL   BL   GI
...
void	DrawScanLineGouraudNoZBufferZWriteSolid_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
void	DrawScanLineGouraudZBufferSolid_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
void	DrawScanLineGouraudZBufferNoZWriteSolid_AsmX86FPU(EdgeAsmFPU *pLeft, EdgeAsmFPU *pRight)
{
	TDest	=Dest;
	Red		=Green	=0;
	_asm
...
#pragma warning (default:4410)	//illegal size for operand
